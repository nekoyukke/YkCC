...
try:
    ...
    # When running this file directly (python src\assembler\mililiconvert.py),
    # the parent of the project root might not be on sys.path so `import src` fails.
    # Add the repository root (two levels up from this file: .../src/assembler -> repo root)
    import sys
