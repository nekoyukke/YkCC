...
try:
    # Preferred: import via package name when the project root is on sys.path
    import src.util as util
except Exception:
    try:
        # If executed as a module within the package, a relative import may work
        from .. import util as util
    except Exception:
        # Fallback: add repository root to sys.path so `import src.util` works
        import sys
